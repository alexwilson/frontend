...
const writing: Article[] = [
  ...
  { contentId: '3', title: 'The case for boring technology', slug: '/blog/boring-tech', date: '2023-06-20', image: null, content: { excerpt: 'Choosing dull tools is often the most exciting decision.' } },
]

const weeknotes: Article[] = [
  { contentId: '4', title: 'Weeknotes #42', slug: '/blog/weeknotes-42', date: '2023-09-05', image: null, content: { excerpt: 'A quiet week. Some progress on the monorepo.' } },
  { contentId: '5', title: 'Weeknotes #41', slug: '/blog/weeknotes-41', date: '2023-08-29', image: null, content: { excerpt: 'Shipped the redesign.' } },
  { contentId: '6', title: 'Weeknotes #40', slug: '/blog/weeknotes-40', date: '2023-08-22', image: null, content: { excerpt: 'Back from holiday.' } },
]
